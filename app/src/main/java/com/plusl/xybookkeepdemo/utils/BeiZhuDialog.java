package com.plusl.xybookkeepdemo.utils;
...
public class BeiZhuDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beizhu_popup);//设置对话框显示布局
        et = findViewById(R.id.dialog_beizhu_et);
        cancelBtn = findViewById(R.id.cancel_button_beizhu);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.cancel_button_beizhu:
                cancel();
                break;
